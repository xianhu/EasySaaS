...
def layout(pathname, search):
    ...
    if pathname == f"{PATH_REGISTERE}/result" or pathname == f"{PATH_RESETPWDE}/result":
        ...
        return palert.layout(pathname, search, "Sending success", text_sub, "Back to home", PATH_INTROS)
    ...
    if pathname == f"{PATH_REGISTERE}-pwd/result" or pathname == f"{PATH_RESETPWDE}-pwd/result":
        ...
        return palert.layout(pathname, search, "Setting success", text_sub, "Go to login", PATH_LOGIN)
