...
def layout(
        pathname, search, tid, data, header_list, key_list,
        title_key=None, out_key=None, th_class=None, td_class=None, data_class=None,
    ...
    thead = html.Thead(html.Tr(th_list), id=tid + "-head")
    ...
    for index, item_info in enumerate(data or []):
        ...
        tr_list.append(html.Tr(td_list, id=tr_id, title=tr_title))
