...
def layout(pathname, search):
    ...
    content = dbc.Row(children=[
        ...
        dbc.Col(children=[
            ...
            html.Div(cat_title, className="bg-white border rounded", style={"min-height": "900px"})
        ], width=12, md=10, class_name="bg-light h-100-scroll px-md-4"),
    ], align="start", justify="center", class_name="h-100-scroll w-100 mx-auto")

    # define components
    navbar = cnavbar.layout(pathname, search, fluid=True)
    content = dbc.Container([small_display, content], fluid=True, class_name="h-100-scroll p-0")
